...
Most service secrets live in Vault (`kv/homelab/data/<service>`), not in local vars files. See **[docs/seeding-vault-secrets.md](../docs/seeding-vault-secrets.md)** for curl commands and instructions for obtaining each credential.
